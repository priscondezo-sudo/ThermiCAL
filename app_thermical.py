...
# =============================================================================
# DICCIONARIO DE CALIBRACIÓN
# Clave:  (zona, "HH:MM - HH:MM")   ← rango de hora del vuelo
# Valor:  ("DD/MM/YYYY", A, B)       → T_cal = A * T_raw + B
#
# Si una zona tiene el mismo rango horario en distintas fechas,
# se diferencia mostrando la fecha entre paréntesis en el label del selectbox.
# =============================================================================
ecuaciones = {
    # ── Caballito ────────────────────────────────────────────────────────────
...
# Rangos horarios disponibles para esa zona
rangos_zona = [k[1] for k in ecuaciones if k[0] == zona]
# Ordenar por hora de inicio (primeros 5 chars "HH:MM")
rangos_zona = sorted(rangos_zona, key=lambda r: r[:5])
...
if registro:
    fecha, A, B = registro
    # Extraer solo el rango limpio (sin la fecha entre corchetes) para mostrar
...
# =============================================================================
# Subir imagen y descargar corregida
# =============================================================================
