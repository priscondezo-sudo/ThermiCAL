...
# Clave:  (zona, "HH:MM - HH:MM  [DD/MM/YYYY]")
...
# =============================================================================
# UI — Selección zona y rango horario
# =============================================================================
...
if uploaded_file is not None and A is not None:
    ...
    # Guardar como TIFF y ofrecer descarga
    out_buffer = io.BytesIO()
    tifffile.imwrite(out_buffer, calibrated.astype(np.float32))
    out_buffer.seek(0)
